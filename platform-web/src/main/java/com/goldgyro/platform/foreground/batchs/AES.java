...
*/
		...
		String str= "zM4H2W1kYvmw9i5IrM6Yf81FRA3pCDE33uTgxKABBz9nCB4wq6asIkbO9tN+MeEi4Mj/0QvA31tZ7Djk4QDj5QaHIzvx+uEe3KaaxTncn9dyNLdE+Y1MrfNPZCXNFyRC4gotssriHvOUT8tl\r\n" + 
				"ckX2UimI3z2XHK7uyfUvylnxdDIxfl4THJfHhYk/TlYyXMFe9P1UPWS1AOiiGhbWnclDMA7aB5B5FURtRyjFb18ITOcl1SoImXMG0L2ZR4IRdl4JDGf3rXxvZ0Dw5H8S7YU+oTY6V7arwnQGarATy2vX02rvNdjTK+G/PK4pAxcwxZq/fQDjkD0+UHnE0yhHG+HOlkFXPonnePrI6swcQ7OOBsECD4pIJvOdPA8vPqnJv\r\n" + 
				"R36";
		
		System.out.println(decode(Base64.decode(str.getBytes()), PayChannelConstants.KEY.substring(0,16)));
	}
