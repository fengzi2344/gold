...
import com.goldgyro.platform.core.comm.utils.StringEscapeEditorUtils;
import com.goldgyro.platform.core.sys.domain.AccountProfile;
import com.goldgyro.platform.foreground.auth.AccountSubject;
...
public class BaseController {
	...
	public void initBinder(ServletRequestDataBinder binder) {
		 ...
		 * 防止XSS攻击
		 */
		binder.registerCustomEditor(String.class, new StringEscapeEditorUtils(true, false));
	}
